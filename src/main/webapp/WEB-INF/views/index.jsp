...
<table class="table_dark">
    ...
    <tr><td><a href="${pageContext.request.contextPath}/drivers/cars" class="btn btn-success">My cars</a></td></tr>
    <tr><td><a href="${pageContext.request.contextPath}/logout" class="btn btn-success">Log out</a></td></tr>
</table>
</body>
</html>
